...
export type ModelImageCollectionConditionInput = {
  parkID?: ModelIntInput | null;
  upload_date_time?: ModelStringInput | null;
  completed?: ModelBooleanInput | null;
  flightID?: ModelIntInput | null;
...
export type ModelImagesConditionInput = {
  collectionID?: ModelIntInput | null;
...
export class APIService {
  ...
  async CreateFlight(
    ...
    const statement = `mutation CreateFlight($pilotID: Int, $height: Int, $type: String) {
  ...
  async CreateImage(
    ...
    const statement = `mutation CreateImage($collectionID: Int, $bucket_name: String, $file_name: String) {
  ...
  async GetParkId(name?: string): Promise<number | null> {
    ...
    return <number | null>response.data.getParkId;
  }
  ...
  async GetImagesByCollectionId(
    ...
    const statement = `query GetImagesByCollectionId($id: Int) {
  ...
  async GetImage(imageID?: number): Promise<GetImageQuery> {
    const statement = `query GetImage($imageID: Int) {
  ...
  async ListUsers(
    ...
    const statement = `query ListUsers($userID: Int, $filter: ModelUserFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
  ...
  async GetGamePark(parkID: number): Promise<GetGameParkQuery> {
    const statement = `query GetGamePark($parkID: Int!) {
  ...
  async ListGameParks(
    ...
    const statement = `query ListGameParks($parkID: Int, $filter: ModelGameParkFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
  ...
  async GetImageCollection(
    ...
    const statement = `query GetImageCollection($collectionID: Int!) {
  ...
  async ListImageCollections(
    ...
    const statement = `query ListImageCollections($collectionID: Int, $filter: ModelImageCollectionFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
  ...
  async GetMessage(messageID: number): Promise<GetMessageQuery> {
    const statement = `query GetMessage($messageID: Int!) {
  ...
  async ListMessages(
    ...
    const statement = `query ListMessages($messageID: Int, $filter: ModelMessageFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
  ...
  async GetImages(imageID: number): Promise<GetImagesQuery> {
    const statement = `query GetImages($imageID: Int!) {
  ...
  async ListImages(
    ...
    const statement = `query ListImages($imageID: Int, $filter: ModelImagesFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
  ...
  async GetFlightDetails(flightID: number): Promise<GetFlightDetailsQuery> {
    const statement = `query GetFlightDetails($flightID: Int!) {
  ...
  async ListFlightDetails(
    ...
    const statement = `query ListFlightDetails($flightID: Int, $filter: ModelFlightDetailsFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
  ...
  async GetPendingInvites(inviteID: number): Promise<GetPendingInvitesQuery> {
    const statement = `query GetPendingInvites($inviteID: Int!) {
  ...
  async ListPendingInvites(
    ...
    const statement = `query ListPendingInvites($inviteID: Int, $filter: ModelPendingInvitesFilterInput, $limit: Int, $nextToken: String, $sortDirection: ModelSortDirection) {
